                    ...
                    {this.state.data_arr.map(item => {
                        return (
                            <div data-aos="fade-right"
                                ...
                                <img className='mt-2' src={item.img} height={"150px"} />
                                <h2 className='t-about text-end '>{item.name}</h2>
                                <div className='t-about text-end' >{item.kind}: סוג מטפל</div>
                                <div className='t-about text-end'>{item.city}: עיר</div>
                                <div className='t-about text-end'>{item.discrption}: תיאור</div>
                                <div className='t-about text-end'>discrption:{item.Certificates}: תארים</div>
